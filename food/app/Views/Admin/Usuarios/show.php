            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    ...
                    <a href="<?php echo site_url("admin/usuarios/editar/$usuario->id"); ?>"
                       class="btn btn-dark btn-sm btn-icon-text btn-icon-prepend mr-2">
                        Editar</a>

                    <a href="<?php echo site_url("admin/usuarios/excluir/$usuario->id"); ?>"
                       class="btn btn-danger btn-sm btn-icon-text btn-icon-prepend mr-2">
                        Excluir</a>

                    <a href="<?php echo site_url("admin/usuarios"); ?>"
                       class="btn btn-light text-dark btn-sm btn-icon-text btn-icon-prepend">
                        Voltar</a>
